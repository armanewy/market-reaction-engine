...
- source_documents_recovered: 9
- parsed_event_rows: 9
- reviewed_usable_rows: 0
- actual_funded_award_rows: 8
- ceiling_only_rows: 1
- modification_or_option_rows: 0
- rows_with_recipient_mapping_confidence_high: 9
- rows_with_award_amount_pct_market_cap: 0
- rows_with_obligated_amount_pct_market_cap: 0
- rows_with_contract_ceiling_pct_market_cap: 0
- rows_with_pre_event_market_adjusted_runup: 9
- small_mid_cap_rows: 0
- likely_oos_predictions_min_train: 0
- top_ticker_share: 0.2222222222222222
- parser_audit_rows: 0
