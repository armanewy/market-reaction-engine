...
NUMERIC_FEATURES = [
    ...
    "new_guidance_vs_current_actual_pct",
    "current_guidance_vs_prior_guidance",
    "current_guidance_vs_prior_guidance_pct",
    "actual_vs_prior_guidance_rank_by_ticker",
    "current_guidance_vs_prior_guidance_rank_by_ticker",
    ...
    "pre_event_return_60d",
    "pre_event_benchmark_return_20d",
    "pre_event_benchmark_return_60d",
